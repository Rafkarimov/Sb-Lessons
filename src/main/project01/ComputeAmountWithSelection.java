...
является 0, то окончание – американских долларов. Но у этого правила есть исключения, когда для всех сумм в
американских долларах в диапазоне от 11 до 14, от 111 до 114, от 211 до 214 и т.д., окончание – американских долларов.
Мы рассмотрим исключения только из диапазона от 11 до 14, чтобы не усложнять алгоритм решения задачи.
...
часть 3:
вводные данные
количество конвертаций: -1
введите корректное количество конвертаций: 3
...
public class ComputeAmountWithSelection {
    public static void main(String[] args) {
        ...
        //До тех пор, пока не конвертированы все суммы, получать, отображать и конвертировать суммы денег в
        //американских долларах и отображать суммы денег в российских рублях
        for (i = 0; i < n; ++i) {
